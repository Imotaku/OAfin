    ...
    <aside id="sidebar_left" class="nano nano-light affix">
        <div class="sidebar-left-content nano-content">
            ...
            <ul class="nav sidebar-menu">
                ...
                <li class="sidebar-label pt15">文件公告管理</li>
                <li>
                    <a class="accordion-toggle" href="#">
                    ...
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/uploadFile/list">
                                <span class="glyphicon glyphicon-duplicate"></span>查看文件</a>
                        </li>
                        <li class="active">
                            <a href="/uploadFile/toAdd">
                                <span class="glyphicon glyphicon-cloud-upload"></span> 上传文件 </a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a class="accordion-toggle" href="#">
                        ...
                        <span class="sidebar-title">公告管理</span>
                        <span class="caret"></span>
                    </a>
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/adverstise/list">
                                <span class="glyphicon glyphicon-list-alt"></span> 查看公告 </a>
                        </li>
                        <li class="active">
                            <a href="/adverstise/toAdd">
                                <span class="glyphicon glyphicon-check"></span> 发布公告 </a>
                        </li>
                    </ul>
                </li>
